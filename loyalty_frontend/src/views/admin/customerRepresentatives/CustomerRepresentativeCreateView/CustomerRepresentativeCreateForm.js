...
function CustomerRepresentativeCreateForm({
  className,
  isPopup = false,
  ...
  return (
    <Formik
      ...
      onSubmit={async (values, {
        ...
        try {
          const response = await axios.post(`${API_BASE_URL}/admin/customer-representative`, values);

          setStatus({ success: response.data.status });
          setSubmitting(false);
          enqueueSnackbar('Customer Representative created', {
            variant: 'success',
            action: <Button>See all</Button>
          });

          if (!isPopup) {
            // history.push('/app/management/customer-representatives');
          } else {
            setModalIsOpenToFalse();
          }
        } catch (error) {
...
CustomerRepresentativeCreateForm.propTypes = {
  className: PropTypes.string,
  isPopup: PropTypes.bool,
  setModalIsOpenToFalse: PropTypes.func,
};

export default CustomerRepresentativeCreateForm;
